...
def init_preprocessed():
    ...
    X_train, X_test, y_train, y_test = train_test_split( Xall, yall, test_size=0.25, stratify=yall,random_state=0)
    ...
    X_train, X_test, y_train, y_test = train_test_split( Xmal, ymal, test_size=0.25, stratify=ymal,random_state=0)
