...
//            fitnessResult =  0.5 * Math.exp(this.missesRemaining*1.0);
            fitnessResult = this.missesRemaining;
//            fitnessResult =  (Math.pow(2,missesRemaining));
//            System.out.println("FOUND A SOLUTION in intertions:" + iterations);
        }
